...
Saída
Um número decimal que representa o saldo atualizado na conta bancária após o processamento das
transações.
...
def saldo_final(atual, deposito, retirada):
    return f"{(atual+deposito)-retirada:0.1f}"

print(f"Saldo atualizado na conta: {saldo_final(saldo_atual,valor_deposito,valor_retirada)}")