"""Imagine que você está desenvolvendo um aplicativo para um banco que deseja calcular os juros compostos
 de um investimento. Seu objetivo é criar uma função que receba três parâmetros:
...
def valor_final(valor_inicial,taxa_juros,periodo):
...
print(f"Valor final do investimento: R$ {valor_final(valor_inicial,taxa_juros,periodo):.2f}")